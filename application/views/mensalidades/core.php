							...
							<div class="card">
								...
								<div class="card-body">
									...
									<form class="forms-sample" name="form_core" method="post">
												...
												<select class="form-control mensalistas select2" name="mensalidade_mensalista_id" <?php echo (isset($mensalidade) ? 'disabled' : ''); ?>>
													...
													<?php foreach ($mensalistas as $mensalista): ?>
														...
														<?php if (isset($mensalidade)): ?>
															...
															<option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>" <?php echo ($mensalista->mensalista_id == $mensalidade->mensalidade_mensalista_id ? 'selected' : '') ?>><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Telefone&nbsp&nbsp;' . $mensalista->mensalista_telefone_movel; ?></option>

														<?php else: ?>

															<option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalista_dia_vencimento ?>"><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;Telefone&nbsp&nbsp;' . $mensalista->mensalista_telefone_movel; ?></option>
										...
										<?php else: ?>
											<a title="Cadastrar mensalidade" href="javascript:void(0)" class="btn btn btn-primary mr-2" data-toggle="modal" data-target="#mensalidade">Enviar</i></a>
										<?php endif; ?>
											...
											<div class="modal-dialog modal-dialog-centered" role="document">
												<div class="modal-content">
													<div class="modal-header">
														<h5 class="modal-title" id="demoModalLabel"><i class="text-danger"></i>&nbsp;&nbsp;Confirmação de dados!</h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
													</div>
													<div class="modal-body">
														<span class="text-dark font-weight-bold"><?php echo $texto_modal; ?></span></br>
														<p></p>
														Clique em <span class="text-primary">"Sim"</span> para salvar.
													</div>
