...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Mar-2021 às 04:28
...
(2, 'Veículo Médio', '1000,00', '1500,00', 30, 1, '2021-03-15 05:04:42');
...
(1, '127.0.0.1', 'administrator', '$2y$12$OSO6Rq95xD1CTg5Gf1JoD.VrNmtpmIlI4mIaSklpc2gitDinCAJNe', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1615916316, 1, 'Osvaldo', 'Queta', 'ADMIN', '926219731', '2021-03-16 17:38:36'),
...
--
ALTER TABLE `precificacoes`
  MODIFY `precificacao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
